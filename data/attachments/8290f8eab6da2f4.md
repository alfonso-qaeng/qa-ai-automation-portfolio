...
- Name: e2e/checkout/checkout.spec.ts >> Checkout flow >> removes an item from the cart and reflects the empty state
- Location: src/tests/e2e/checkout/checkout.spec.ts:52:7
